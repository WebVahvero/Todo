...
/* harmony export */   "addToLibrary": () => (/* binding */ addToLibrary),
...
class Project {
    constructor(title, ...tasks) {
        this.title = title;
        this.date = (0,date_fns__WEBPACK_IMPORTED_MODULE_0__["default"])(new Date(), "c.M.y 'at' kk.mm");
        this.tasks = tasks;
    }
};

function addToLibrary(project) {
...
/* harmony import */ var _Functions_Project__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./Functions/Project */ "./src/Functions/Project.js");
/* harmony import */ var _views_createProject__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./views/createProject */ "./src/views/createProject.js");
...
const appendToPage = () => {
    ...
    content.appendChild((0,_views_createProject__WEBPACK_IMPORTED_MODULE_4__["default"])());
...
window.onload = () => {
    ...
    createProjectBtn.addEventListener('click', event => {
        ...
        (0,_Functions_Project__WEBPACK_IMPORTED_MODULE_3__.addToLibrary)(new _Functions_Project__WEBPACK_IMPORTED_MODULE_3__.Project(projectTitle, taskNameArr));

        console.log(_Functions_Project__WEBPACK_IMPORTED_MODULE_3__.projectLibrary);
    });
};

const project1 = new _Functions_Project__WEBPACK_IMPORTED_MODULE_3__.Project('TÖIHIN!', 
{
    name: 'Töihin',
    status: false
},
